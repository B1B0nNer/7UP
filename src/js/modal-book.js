...
let  modalHtml =  ` <div class="container-modal js-modal">
     ...
     <img src="${bookObj.img}" alt="image book ${bookObj.bookName}" width="287" height="408"></img> 
      ...
      <div class="info-book">
      <h2 class="text_card_title name-book">${bookObj.bookName}</h2>
     <p class="text_card_author text-author">${bookObj.author}</p>
...
export async function openModal(event) {
  ...
  const instance = basicLightbox.create(await addConten(bookID), {
    onShow: () => {
